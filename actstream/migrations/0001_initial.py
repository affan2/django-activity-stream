...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'actstream_action', (
            ...
            ('batch_time_minutes', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('is_batchable', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
