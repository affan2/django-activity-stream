...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.timestamp_date'
        db.add_column(u'actstream_action', 'timestamp_date',
    ...
    def backwards(self, orm):
        # Deleting field 'Action.timestamp_date'
        db.delete_column(u'actstream_action', 'timestamp_date')
