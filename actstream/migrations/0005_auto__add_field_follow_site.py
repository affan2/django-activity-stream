...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'actstream_follow', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='follow_site', to=orm['sites.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Follow.site'
        db.delete_column(u'actstream_follow', 'site_id')
    ...
    models = {
        ...
        u'actstream.follow': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'follow_site'", 'to': u"orm['sites.Site']"}),
